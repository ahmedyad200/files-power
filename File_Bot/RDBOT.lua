...
send(msg.chat_id_,msg.id_, 'نعم حبيبي المبرمج 🥺️\n❤️') 
return false
end

if text == 'بوت' and SudoBot(msg) then 
send(msg.chat_id_,msg.id_, 'نعم حبيبي المطور 🥺️\n❤️') 
return false
end
...
send(msg.chat_id_,msg.id_, 'نعم حبيبي المدير 🥺️\n❤️ ') 
return false
end
...
send(msg.chat_id_,msg.id_, ' نعم حبيبي المنظف 🥺️\n❤️ ') 
return false
end

if text == 'بوت' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, ' نعم حبيبي المالك 🥺️\n❤️ ') 
return false
end

if text == 'بوت' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, 'نعم حبيبي المنشئ 🥺️\n❤️') 
return false
end
...
send(msg.chat_id_,msg.id_, ' نعم حبيبي الادمن 🥺️\n❤️ ') 
return false
end
...
send(msg.chat_id_,msg.id_, ' نعم حبيبي المميز 🥺️\n❤️ ') 
return false
end

if text == 'بوت' then
send(msg.chat_id_,msg.id_, 'نعم حبيبي العضو 🥺️\n❤️ ') 
return false
end
